// =============================================================================
// layer_processor_fc3_proto.sv
//
// MODIFIED version of layer_processor.sv for the FC3 prototype.
// Only change vs original: weight_sram and bias_sram are replaced by
// fc3_weight_rom and fc3_bias_rom shims.
//
// Use this file INSTEAD of layer_processor.sv in your Quartus project.
// (Remove layer_processor.sv from the project, add this one.)
// =============================================================================
...
module lenet5_layer_processor #(
    ...
    // Weight/bias write ports - kept for port compatibility but unused
    ...
    // =========================================================================
    // Internal SRAM-interface signals
    // (Same names as original - only the modules driving them change)
    // =========================================================================
    ...
    // =========================================================================
    // WEIGHT ROM SHIM  (replaces weight_sram_lenet5_actual)
    // =========================================================================
    fc3_weight_rom #(
    ...
    // =========================================================================
    // BIAS ROM SHIM  (replaces bias_sram_lenet5)
    // =========================================================================
    fc3_bias_rom #(
        .NUM_BIASES (MAX_BIASES),
        .MAX_BURST  (MAX_BURST_LEN)
    ) bias_memory (
        .clk           (clk),
        .rst           (rst),
    ...
    // =========================================================================
    // CONV + BIAS + REQUANT PIPELINE  (unchanged from original)
    // =========================================================================
