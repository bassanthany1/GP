...
module fc3_bias_rom #(
    ...
    initial begin
        ...
        $readmemh("E:/lcd_malaria/biases_malaria.mem", rom, 0, NUM_BIASES-1);
		 // $readmemh("D:/GP/ALL_FLOW_FILES/f3_layer_files/fc3_biases.mem", rom, 0, NUM_BIASES-1);
    end
